...
type ModalEditFoodProps = {
  ...
  isOpen: boolean;
  handleUpdateFood: (food: FoodResponse) => Promise<void>;
  setIsOpen: () => void;
};

const ModalEditFood = ({ isOpen, handleUpdateFood, setIsOpen, editingFood }: ModalEditFoodProps): JSX.Element => {
  const formRef = useRef(null);

  const handleSubmit = async (data: FoodResponse) => {
